        ...
        <header className="hidden lg:flex flex-col md:flex-row items-center justify-between border-b border-solid border-slate-200 dark:border-slate-800 px-4 md:px-10 py-3 mb-6 gap-4 w-full">
            <div className="flex items-center gap-8 w-full md:w-auto justify-between md:justify-start">
                <div className="flex items-center gap-4 text-slate-900 dark:text-slate-100">
                    ...
                    <h2 className="text-slate-900 dark:text-slate-100 text-xl font-bold leading-tight tracking-[-0.015em]">ClinicAdmin</h2>
                </div>
            ...
            <div className="flex flex-1 justify-end gap-8 w-full md:w-auto">
                <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 border-2 border-slate-200 dark:border-slate-700" title="Admin profile" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuC1zorCviQPpCpZ_SsoStaTe9Zf4ra7VYZVP49c92oYGPOe63KvXE988IflAzikCTI0K1AaEs2Z_nJhsPa1MvIf_JEdNaVEAso1sXrha9fVp5ya1Ine-n3UdE8HH8lItpVzWlxl_H2yZn_CjCzq17-uJSpATfYr-vE1Xi5oI99o1_PrDj0uaii_bQofFGvy5BSKucfk1inxAFJ33xjnBsNcOtCKrxoNvuDFtBQbSS4HzhXrGbCUxPtCMgm_5kKni6AvGaPklFXVWg')" }}></div>
            </div>
        </header>
    );
};
