        ...
        {childrenList.map((child, idx) => (
            <div key={idx} className="overflow-hidden rounded-xl border border-emerald-200 dark:border-emerald-800/50">
                ...
                <div className="grid grid-cols-2 gap-4 p-5 md:grid-cols-3">
                    ...
                    <div><p className="text-xs text-slate-500">Jumlah Sesi</p><p className="mt-0.5 text-sm font-semibold text-slate-900 dark:text-slate-100">{child.totalSessions || 0} sesi</p></div>
