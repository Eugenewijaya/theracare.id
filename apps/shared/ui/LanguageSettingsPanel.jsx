...
import { LANGUAGE_CHANGED_EVENT, readLanguage, SUPPORTED_LANGUAGES, writeLanguage } from '../i18n/language';
  ...
  return (
    <section className={`rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-800 ${compact ? 'p-4' : 'p-6'}`}>
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h2 className="text-sm font-black uppercase tracking-wider text-slate-900 dark:text-white">Bahasa Tampilan</h2>
          <p className="mt-1 max-w-2xl text-sm leading-relaxed text-slate-500 dark:text-slate-400">
            Pilih bahasa portal. Istilah umum seperti Dashboard, email, dan WhatsApp tetap dipertahankan jika lebih familiar.
          </p>
        </div>
