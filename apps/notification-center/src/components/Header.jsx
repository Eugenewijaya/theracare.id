...
const Header = ({ user }) => {
    ...
    return (
        <header className="hidden lg:flex items-center justify-between gap-4 border-b border-solid border-slate-200 dark:border-slate-800 px-10 py-3 bg-white dark:bg-slate-900 sticky top-0 z-50">
            <div className="flex min-w-0 items-center gap-4">
                ...
                <h2 className="min-w-0 truncate text-lg font-bold leading-tight">{clinicName}</h2>
            </div>
