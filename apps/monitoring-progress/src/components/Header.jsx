        ...
        <header className="hidden lg:flex flex-col md:flex-row items-center justify-between gap-4 border-b border-solid border-border-light dark:border-border-dark px-10 py-3 bg-surface-light dark:bg-surface-dark sticky top-0 z-10 w-full">
            <div className="flex items-center gap-8">
                <div className="flex items-center gap-4 text-primary">
                    ...
                    <h2 className="text-text-light-primary dark:text-text-dark-primary text-lg font-bold leading-tight tracking-[-0.015em]">Clinic Admin</h2>
                </div>
            ...
            <div className="flex flex-1 justify-end gap-8">
                <div className="flex gap-2">
                    <button className="flex items-center justify-center rounded-lg h-10 w-10 bg-background-light dark:bg-background-dark text-text-light-primary dark:text-text-dark-primary hover:text-primary transition-colors relative">
                        <span className="material-symbols-outlined">notifications</span>
                        <span className="absolute top-2 right-2 w-2 h-2 bg-red-500 rounded-full"></span>
                    </button>
                    <button className="flex items-center justify-center rounded-lg h-10 w-10 bg-background-light dark:bg-background-dark text-text-light-primary dark:text-text-dark-primary hover:text-primary transition-colors">
