    ...
    return (
        <aside className="w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-800 flex flex-col flex-shrink-0">
            ...
            <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                ...
                <a className="flex items-center gap-3 px-4 py-3 rounded-xl bg-primary/10 text-primary font-bold" href="/schedule" aria-current="page">
                    <span className="material-symbols-outlined text-xl">calendar_month</span> My Schedule
                </a>
                <a className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors font-semibold" href="/schedule-updates">
                    <span className="material-symbols-outlined text-xl">checklist</span> Attendance
                </a>
                <a className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors font-semibold" href="/reports">
                    <span className="material-symbols-outlined text-xl">description</span> Daily Reports
                </a>
                <a className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors font-semibold" href="/child-progress">
                    <span className="material-symbols-outlined text-xl">group</span> Patients
                </a>
                <a className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors font-semibold" href="/settings">
