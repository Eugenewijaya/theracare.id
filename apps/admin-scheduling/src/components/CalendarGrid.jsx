...
const CalendarGrid = ({ currentView, onDateClick, onEventClick, selectedMonth, selectedYear, sessions = [], childrenList = [] }) => {
                    ...
                    {['09:00 AM', '10:00 AM', '11:00 AM', '12:00 PM', '01:00 PM', '02:00 PM', '03:00 PM', '04:00 PM'].map(hour => (
                        <div key={hour} className="flex gap-4 items-start border-b border-slate-100 dark:border-slate-800/50 pb-4">
                            ...
                            <div
                                ...
                                title="Klik untuk lihat detail sesi hari ini"
                            />
                        </div>
                    ))}
                </div>
                    ...
                    return (
                        ...
                        >
                            <div className="flex justify-between items-start">
                                ...
                                <span className="material-symbols-outlined text-[18px] text-primary opacity-0 group-hover:opacity-100 transition-opacity">event_note</span>
                            </div>
