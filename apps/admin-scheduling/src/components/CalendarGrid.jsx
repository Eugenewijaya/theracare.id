...
const CalendarGrid = ({ currentView, onDateClick, onEventClick, selectedMonth, selectedYear, selectedDate, sessions = [], childrenList = [] }) => {
                                    ...
                                    <div className="min-h-[52px] rounded-xl bg-slate-50 p-2 dark:bg-slate-900/50">
                                        {slotSessions.length > 0 ? (
                                            ...
                                            <button
                                                ...
                                                className="flex h-12 w-full items-center justify-center rounded-lg border border-dashed border-slate-200 text-sm font-semibold text-slate-400 transition hover:border-primary/40 hover:bg-primary/5 hover:text-primary dark:border-slate-800"
                                            >
                                                Tersedia
                                            </button>
                                        )}
